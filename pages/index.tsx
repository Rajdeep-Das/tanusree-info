...
const Home: NextPage = () => {
const [newTime, setNewTime] = useState<number>(7)
...
useEffect(() => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-[#1e1f29]">
      <Head>
        <title>Tanusree | UI/UX Designer</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <Header message={message? message: "Tanusree Bhar."}/>
      <SubHeader message="UI/UX Designer"/>
      <TimerContainer
        days={days}
        hours={hours}
        minutes={minutes}
